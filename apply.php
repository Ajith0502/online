...
if(isset($_POST['Register'])){
    ...
    if(mysqli_num_rows($dublicate) > 0){
        ...
        if($password == $confirmpassword){
            $query ="INSERT INTO doctor  VALUES('','$name','$username','$email','$password')";
...
<body style="background-image:url(apba.jpg);background-repeat:no-repeat;background-size:cover">
<?php
include "header.php";
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 my-3 jumbotron">
                <h5 class="text-center"style="font-size:30px;color:blue">Apply Now!!!</h5>
